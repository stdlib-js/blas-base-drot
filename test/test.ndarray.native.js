...
var drot = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
	'skip': ( drot instanceof Error )
};
...
tape( 'the function returns a reference to the second input array', opts, function test( t ) {
	...
	out = drot( x.length, x, 1, 0, y, 1, 0, 1, 0 );
